...
class DuckDBConnectorTestCase(unittest.TestCase):
    ...
    def test_execute_query_once_empty_result(self):
        ...
        self.assertEqual(colnames, ["id", "name", "email", "age", "is_active", "salary", "created_at"])
    ...
    def test_generate_duckdb_schema_multi_schema_specific(self):
        ...
        schema = defog.generate_db_schema(["test_schema.orders"], upload=False, scan=False)
    ...
    def test_memory_database_credentials(self):
        ...
        try:
            defog = Defog(api_key="test_key", db_type="duckdb", db_creds=memory_db_creds)
    ...
    def test_file_path_validation(self):
        ...
        try:
            defog = Defog(api_key="test_key", db_type="duckdb", db_creds=invalid_db_creds)
...
class AsyncDuckDBConnectorTestCase(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_async_generate_duckdb_schema_specific_tables(self):
        ...
        schema = await defog.generate_db_schema(["async_users"], upload=False, scan=False)
    ...
    async def test_async_generate_duckdb_schema_return_tables_only(self):
        ...
        # Test returning table names only
        tables = await defog.generate_db_schema([], upload=False, return_tables_only=True)
