...
class TestClaudePDFProcessor:
    ...
    @pytest.mark.asyncio
    async def test_process_single_chunk_success(self, mock_chat_async, claude_processor):
        ...
        result = await claude_processor._process_single_chunk(
            pdf_chunks, task, 0, 1
        )
    ...
    @patch('defog.llm.pdf_processor.chat_async')
    @pytest.mark.asyncio
    async def test_process_single_chunk_failure(self, mock_chat_async, claude_processor):
    ...
    def test_combine_chunk_results(self, claude_processor):
        ...
        chunk_results = [
            {
                "success": True,
                "content": "Analysis of chunk 1",
                "chunk_index": 0
            },
            {
                "success": True,
                "content": "Analysis of chunk 2",
                "chunk_index": 1
            },
            {
                "success": False,
