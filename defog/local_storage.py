...
class LocalStorage:
    ...
    # Metadata methods
    def save_metadata(self, metadata: Dict[str, Any], api_key: Optional[str] = None, db_type: str = "") -> Dict[str, Any]:
    ...
    def get_metadata(self, api_key: Optional[str] = None, db_type: str = "") -> Dict[str, Any]:
    ...
    # Glossary methods
    def save_glossary(self, glossary: str, api_key: Optional[str] = None, db_type: str = "") -> Dict[str, Any]:
    ...
    def delete_glossary(self, api_key: Optional[str] = None, db_type: str = "") -> Dict[str, Any]:
    ...
    def save_golden_queries(self, golden_queries: List[Dict[str, Any]], api_key: Optional[str] = None, db_type: str = "") -> Dict[str, Any]:
        ...
        return {"status": "success", "message": f"Saved {len(golden_queries)} golden queries"}
    
    def get_golden_queries(self, api_key: Optional[str] = None, db_type: str = "") -> List[Dict[str, Any]]:
    ...
    def delete_golden_queries(self, golden_queries: List[str], api_key: Optional[str] = None, db_type: str = "") -> Dict[str, Any]:
        ...
        remaining_queries = [q for q in existing_queries if q["question"] not in questions_to_delete]
        ...
        return {"status": "success", "message": f"Deleted {deleted_count} golden queries"}
    
    # Schema storage (for removed upload functionality)
    def save_schema(self, schema_data: str, filename: str, api_key: Optional[str] = None, db_type: str = "") -> Dict[str, Any]:
