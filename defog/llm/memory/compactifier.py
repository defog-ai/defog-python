...
async def smart_compactify(
    ...
    **kwargs
    ...
    if not memory_manager.should_compactify():
        return memory_manager.get_current_messages(), memory_manager.history.total_tokens
    
    # Get messages to summarize and preserve
    system_messages, messages_to_summarize, preserved_messages = memory_manager.get_messages_for_compactification()
