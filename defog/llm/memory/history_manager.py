...
class ConversationHistory:
    ...
    def replace_messages(self, new_messages: List[Dict[str, Any]], new_token_count: int) -> None:
...
class MemoryManager:
    ...
    def add_messages(self, messages: List[Dict[str, Any]], tokens: int) -> None:
        ...
        for message in messages:
            self.history.add_message(message, tokens // len(messages) if messages else 0)
    
    def get_messages_for_compactification(self) -> tuple[List[Dict[str, Any]], List[Dict[str, Any]], List[Dict[str, Any]]]:
        """
        ...
        return system_messages, other_messages[:split_index], other_messages[split_index:]
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "last_compactified_at": self.history.last_compactified_at.isoformat() if self.history.last_compactified_at else None,
